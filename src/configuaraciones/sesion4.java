 ...
 * @author Usuario
 */
public class sesion4 extends javax.swing.JFrame {
 ...
 count=count-1;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sesion4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
