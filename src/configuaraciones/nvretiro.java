 ...
 * @author Usuario
 */
public class nvretiro extends javax.swing.JFrame {
...
ramdom();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(nvretiro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
