 ...
 * @author Usuario
 */
public class envcu extends javax.swing.JFrame {
  ...
  public void tpmcon(){
   ...
   public void tpmcon1(){
    ...
    String [] dat = new String[1];
           ...
           Statement st = cn.createStatement();
           ResultSet rs = st.executeQuery("SELECT id_tpm FROM tipo_movimiento WHERE cod_tpm='" + id1.getText() + "'");
    ...
    public void consulsal1(){
       String [] dat = new String[1];
        
           try{

           Statement st = cn.createStatement();
           ResultSet rs = st.executeQuery("SELECT saldo_cu FROM cuenta WHERE id_cu='" + ctin1.getText() + "'");
   ...
   public void consulusuid1(){
       String [] dat = new String[1];
        
           try{

           Statement st = cn.createStatement();
           ResultSet rs = st.executeQuery("SELECT id_usu FROM cuenta WHERE id_cu='" + ctin1.getText() + "'");
    ...
    public void consulusu1(){
       String [] dat = new String[1];
        
           try{

           Statement st = cn.createStatement();
           ResultSet rs = st.executeQuery("SELECT nombre_usu FROM usuarios WHERE id_usu='" + idu1.getText() + "'");
...
"            \n\n\nVALOR DE LA TRNSACCION\n"+vl);
    ...
    try{
            ...
            pst.setString(1, cod1.getText());
            pst.setString(2, nom_usu1.getText());
            pst.setString(3, tpm1.getText());
            pst.setString(4, can.getText());
            pst.setString(5, ctin1.getText());
    ...
    public void saldocu(){
     ...
     int num1=0,num2=0,res=0;
        ...
        num1= Integer.parseInt(salex.getText().trim());
    ...
    public void saldocu1(){
    
    
     int num1=0,num2=0,res=0;
        
        num1= Integer.parseInt(salex1.getText().trim());
        num2= Integer.parseInt(can.getText());
        //RECOJO VALOR
      ...
      try{
             PreparedStatement pst = cn.prepareStatement("UPDATE cuenta SET saldo_cu='" + total1.getText()+ "' WHERE id_cu='" + ctin1.getText() + "'");
              pst.executeUpdate();
    ...
    private void initComponents() {
        ...
        salex = new javax.swing.JTextField();
        ...
        ctin1 = new javax.swing.JTextField();
        id1 = new javax.swing.JTextField();
        idu1 = new javax.swing.JTextField();
        cod1 = new javax.swing.JTextField();
        nom_usu1 = new javax.swing.JTextField();
        tpm1 = new javax.swing.JTextField();
        salex1 = new javax.swing.JTextField();
        ...
        ctin.setEditable(false);
        ctin.setBackground(new java.awt.Color(0, 51, 153));
        ...
        salex.setEditable(false);
        salex.setBackground(new java.awt.Color(0, 51, 153));
        salex.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
        salex.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                salexActionPerformed(evt);
            }
        });

        cod.setEditable(false);
        cod.setBackground(new java.awt.Color(0, 51, 153));
        ...
        nom_usu.setBackground(new java.awt.Color(0, 51, 153));
        ...
        tpm.setBackground(new java.awt.Color(0, 51, 153));
        ...
        can.setBackground(new java.awt.Color(0, 51, 153));

        idu.setEditable(false);
        idu.setBackground(new java.awt.Color(0, 51, 153));
        ...
        ctin1.setBackground(new java.awt.Color(0, 51, 153));
        ctin1.addCaretListener(new javax.swing.event.CaretListener() {
            public void caretUpdate(javax.swing.event.CaretEvent evt) {
                ctin1CaretUpdate(evt);
            }
        });

        id1.setEditable(false);
        id1.setBackground(new java.awt.Color(0, 51, 153));
        ...
        idu1.setEditable(false);
        idu1.setBackground(new java.awt.Color(0, 51, 153));
        idu1.setForeground(new java.awt.Color(255, 255, 255));
        idu1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));

        cod1.setEditable(false);
        cod1.setBackground(new java.awt.Color(0, 51, 153));
        cod1.setForeground(new java.awt.Color(255, 255, 255));
        cod1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));

        nom_usu1.setEditable(false);
        nom_usu1.setBackground(new java.awt.Color(0, 51, 153));
        nom_usu1.setForeground(new java.awt.Color(255, 255, 255));
        nom_usu1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));

        tpm1.setEditable(false);
        tpm1.setBackground(new java.awt.Color(0, 51, 153));
        tpm1.setForeground(new java.awt.Color(255, 255, 255));
        tpm1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));

        salex1.setEditable(false);
        salex1.setBackground(new java.awt.Color(0, 51, 153));
        salex1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
        salex1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                salex1ActionPerformed(evt);
            }
        });

        total1.setEditable(false);
        total1.setBackground(new java.awt.Color(0, 51, 153));
        total1.setForeground(new java.awt.Color(255, 255, 255));
        total1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
        ...
        jPanel12Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel12Layout.createSequentialGroup()
                ...
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel12Layout.createSequentialGroup()
                        .addComponent(ctin, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel12Layout.createSequentialGroup()
                        .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel12Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(salex1, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(salex, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(jPanel12Layout.createSequentialGroup()
                                .addGap(306, 306, 306)
                ...
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(tpm1, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addComponent(nom_usu1, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(cod1, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(idu1, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(18, 18, 18)
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(tpm, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addComponent(nom_usu, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(cod, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(idu, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel12Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(ctin1, javax.swing.GroupLayout.PREFERRED_SIZE, 294, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(189, 189, 189))
            .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel12Layout.createSequentialGroup()
                    .addGap(20, 20, 20)
                    .addComponent(total1, javax.swing.GroupLayout.DEFAULT_SIZE, 100, Short.MAX_VALUE)
                    .addGap(560, 560, 560)))
        );
                ...
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel12Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(salex, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel3))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel5)
                            .addComponent(salex1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(ctin1, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(30, 30, 30)
                        .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel4)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel12Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel12Layout.createSequentialGroup()
                                .addComponent(idu1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(108, 108, 108)
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(tpm1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 18, Short.MAX_VALUE)
                                .addComponent(nom_usu1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel12Layout.createSequentialGroup()
...
insertmov1();
    ...
    private void salexActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salexActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_salexActionPerformed

    private void ctin1CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_ctin1CaretUpdate
        // TODO add your handling code here:
    }//GEN-LAST:event_ctin1CaretUpdate

    private void salex1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salex1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_salex1ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(envcu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public javax.swing.JTextField ctin1;
    private javax.swing.JTextField id;
    private javax.swing.JTextField id1;
    private javax.swing.JTextField idu;
    private javax.swing.JTextField idu1;
    ...
    private javax.swing.JTextField salex;
    private javax.swing.JTextField salex1;
    private javax.swing.JTextField total;
    private javax.swing.JTextField total1;
    private javax.swing.JTextField tpm;
    private javax.swing.JTextField tpm1;
