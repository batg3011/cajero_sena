 ...
 * @author Usuario
 */
public class sesion6 extends javax.swing.JFrame {
 ...
 count=count-1;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sesion6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
